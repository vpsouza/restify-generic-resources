...
exports.default = function (server, modelName, models) {
    return function () {
        ...
        var sequelizeModelInstance = (0, _utils.getModelInstance)(models(server, tenantID), modelName);
        return sequelizeModelInstance.create(modelBody, {
            include: (0, _utils.getIncludedModels)(modelBody, sequelizeModelInstance)
        });
    };
};